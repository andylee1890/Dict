...
RELEASE_ASSET_NAMES = {
    ...
    ("collins-cobuild-overhaul-v2-30", "柯林斯双解预览图.PNG"): "collins-cobuild-bilingual-preview.png",
    ("collins-cobuild-overhaul-v2-30", "柯林斯英英预览图.PNG"): "collins-cobuild-english-preview.png",
    ("word-definition-ratio", "单词释义比例词典-带词性.mdx"): "word-definition-ratio.mdx",
    ("collins-chinese-english-dictionary", "柯林斯汉英大词典.mdx"): "collins-chinese-english-dictionary.mdx",
    ...
    ("oxford-advanced-learner-dictionary-8-oalecd8e", "牛津高阶英汉双解词典(第8版).png"): "oxford-advanced-learner-dictionary-8-preview.png",
    ("oxford-advanced-learner-dictionary-8-oalecd8e", "牛津高阶英汉双解词典(第8版).1.mdd"): "oxford-advanced-learner-dictionary-8-supplement.mdd",
    ("oxford-advanced-learner-dictionary-8-oalecd8e", "牛津高阶英汉双解词典(第8版).mdd"): "oxford-advanced-learner-dictionary-8-primary.mdd",
    ("oxford-advanced-learner-dictionary-8-oalecd8e", "牛津高阶英汉双解词典(第8版).mdx"): "oxford-advanced-learner-dictionary-8.mdx",
    ("oxford-advanced-reverse-dictionary", "牛津高阶英汉双解词典（第9版 汉英+同义词+例句反查）.mdx"): "oxford-advanced-reverse-dictionary.mdx",
    ("oxford-advanced-reverse-dictionary", "牛津高阶英汉双解词典（第9版 汉英+同义词+例句反查）.jpg"): "oxford-advanced-reverse-dictionary.jpg",
    ...
    ("dr-eye-bilingual-dictionary", "译典通英汉双向字典.mdx"): "dr-eye-bilingual-dictionary.mdx",
    ("synonym-differentiation", "近义词词语辨析.mdx"): "synonym-differentiation.mdx",
    ("webster-advanced-english-chinese-dictionary", "韦氏高阶英汉双解词典.mdx"): "webster-advanced-english-chinese-dictionary.mdx",
